...
pub(crate) fn handle_auth(    net: &mut NetConnection,
    ...
    match opcode {
        ...
        // #246：采集（ObjectHarvest/ObjectHarvested）——位置 + Harvest 动作
