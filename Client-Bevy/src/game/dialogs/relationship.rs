// ============================================================================
// 关系对话框（M9 第 3 批）
// 布局参考：macroquad relationship_dialog.rs（背景 Prguse[963]，位置 (300,100)）
// ============================================================================
...
impl Plugin for RelationshipPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            Update,
            (relationship_ui_system, ui_button_system)
                .chain()
...
fn spawn_relationship(
    ...
    if let Some(h) = ui_image(&mut libs, &mut images, &mut cache, LibraryName::Prguse, 963) {
