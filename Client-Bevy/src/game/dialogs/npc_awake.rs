// ============================================================================
// 唤醒对话框（M9 第 4 批）
// 布局参考：macroquad npc_awake_dialog.rs（背景 Title[468]）
// ============================================================================
...
impl Plugin for NpcAwakePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            Update,
            (npc_awake_ui_system, ui_button_system)
                .chain()
...
fn npc_awake_ui_system(
    ...
    mut lines: Query<(&mut Text2d, &NpcAwakeLine)>,
) {
