// ============================================================================
// 好友对话框（M9 第 2 批）
// 布局参考：macroquad friend_dialog.rs
//   - 背景 Title[199]，位置 (300,100)，标题 Title[6] (18,9)
//   - 好友列表 y=40 每 20px；按钮 y=210
// ============================================================================
...
fn spawn_friend(
    ...
    if let Some(e) = crate::ui::sprite_ui::spawn_ui_button(
        ...
        300.0 + 290.0, 103.0, 7.0, 20.0, 20.0,
    ) {
        commands.entity(e).insert((
            FriendClose,
            DialogRoot(DialogKind::Friend),
...
fn friend_ui_system(
    ...
    mut widgets: Query<&mut Visibility, With<FriendWidget>>,
    ...
    for (mut text, line) in &mut lines {
        text.0 = friend.friends.get(line.0).cloned().unwrap_or_default();
    }
}
