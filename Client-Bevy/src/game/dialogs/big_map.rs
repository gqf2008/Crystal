// ============================================================================
// 大地图对话框（M9 第 4 批）
// 布局参考：macroquad big_map_dialog.rs（背景 Title[468]）
// ============================================================================
...
impl Plugin for BigMapPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            Update,
            (big_map_ui_system, ui_button_system)
                .chain()
...
fn big_map_ui_system(
    ...
    mut widgets: Query<&mut Visibility, With<BigMapWidget>>,
    mut lines: Query<(&mut Text2d, &BigMapLine)>,
) {
