...
mod tests {
    ...
    fn monster_attack_action_falls_back_to_attack1_without_frames() {
        ...
        assert_eq!(
            resolve_monster_attack_action(0, 0, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_attack_action(0, 1, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_attack_action(0, 2, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_attack_action(0, 3, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_attack_action(0, 4, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_range_attack_action(0, 0, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_range_attack_action(0, 1, MirDirection::Up, 0),
            MirAction::Attack1
        );
        assert_eq!(
            resolve_monster_range_attack_action(0, 2, MirDirection::Up, 0),
            MirAction::Attack1
        );
