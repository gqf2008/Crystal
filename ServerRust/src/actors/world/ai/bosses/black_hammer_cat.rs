//! BlackHammerCat（黑锤猫）behavior
//!
//! C# 参考：Server/MirObjects/Monsters/BlackHammerCat.cs
//! 机制：InAttackRange 2 格十字/对角；dist<=1 且 2/3 近战 DC / 否则 魔法近战 MC + LineAttack(2, 300)
...
impl MonsterBehavior for BlackHammerCatBehavior {
