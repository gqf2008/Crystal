//! MutatedManworm（变异蠕虫）behavior
//!
//! C# 参考：Server/MirObjects/Monsters/MutatedManworm.cs（继承 CrazyManworm）
//! 机制：攻击 2/3 物理近战（DC，attackType=0）/ 1/3 魔法近战（MC，attackType=1）；
//!      受击反制：承伤>自身 DC 且 1/2 → FindWeakerTarget → TeleportToTarget
...
impl MonsterBehavior for MutatedManwormBehavior {
