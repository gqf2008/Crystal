//! BurningZombie（燃烧僵尸）behavior
//!
//! C# 参考：Server/MirObjects/Monsters/BurningZombie.cs
//! 机制：近战（dist<=1）DC（MACAgility）/ 远程 RangeDamage（MAC，攻速+500ms），无毒
...
impl MonsterBehavior for BurningZombieBehavior {
