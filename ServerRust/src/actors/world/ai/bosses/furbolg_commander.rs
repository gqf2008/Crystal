//! FurbolgCommander（兽人指挥官）behavior
//!
//! C# 参考：Server/MirObjects/Monsters/FurbolgCommander.cs
//! 机制：AttackRange=8；近战（dist<=1）DC / 远程 MC（MACAgility，攻速+500ms）
...
impl MonsterBehavior for FurbolgCommanderBehavior {
