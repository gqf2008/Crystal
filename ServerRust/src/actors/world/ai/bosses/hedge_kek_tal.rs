...
pub struct HedgeKekTalBehavior;

impl Default for HedgeKekTalBehavior {
    fn default() -> Self {
        Self::new()
    }
}

impl HedgeKekTalBehavior {
    pub fn new() -> Self {
        Self
    }
}

impl MonsterBehavior for HedgeKekTalBehavior {
