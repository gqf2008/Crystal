...
pub enum InputEvent {
    ...
    CharInput { character: char, timestamp: Instant },
    ...
    /// 鼠标进入/离开窗口
    MouseEnterOrLeave { entered: bool, timestamp: Instant },
    ...
    /// 触摸取消（被系统中断，如来电）
    TouchCancel { id: u64, timestamp: Instant },
    ...
    /// 窗口获得/失去焦点
    Focus { focused: bool, timestamp: Instant },
}
...
impl InputEvent {
    ...
    pub fn is_window(&self) -> bool {
        matches!(self, InputEvent::Resize { .. } | InputEvent::Focus { .. })
    }
}
