...
use crate::scenes::dialogs::game::{
    amount_box::AmountBoxResult, npc_dialog::NpcDialogAction,
...
pub enum UiCommand {
    ...
    /// 更新宠物列表
    UpdateCreatureList {
        creatures: Vec<crate::scenes::dialogs::game::intelligent_creature_dialog::CreatureEntry>,
    },
    ...
    /// 更新行会仓库金币
    UpdateGuildStorageGold {
        gold: u32,
    },
    /// 更新行会仓库物品列表
    UpdateGuildStorageItems {
        items: Vec<crate::scenes::dialogs::game::guild_dialog::GuildStorageItem>,
    },
    /// 更新行会仓库单个物品
    UpdateGuildStorageItem {
        slot: i32,
        name: String,
        quantity: i32,
    },
    ...
    /// 组队成员列表更新
    UpdateGroupMembers {
        members: Vec<crate::scenes::dialogs::game::group_dialog::GroupMember>,
    },
    /// 组队成员地图信息更新
    UpdateGroupMemberMap {
        player_name: String,
        player_map: String,
    },
    ...
    UpdateStorageInventoryItems {
        items: Vec<mir2_shared::data::item::UserItem>,
    },

    /// 婚姻/师徒
    SetMarriageRequester {
        requester: String,
    },
    ...
    /// 更新邮件列表
    UpdateMailList {
        mails: Vec<crate::ui::ui_state::MailEntry>,
    },
    ...
    /// 耐久度状态
    UpdateDuraStatus {
        items: Vec<crate::scenes::dialogs::game::dura_status_dialog::DuraEntry>,
    },
    ToggleDuraStatus,
    ...
    /// 行会领地
    ShowGuildTerritory,
    UpdateGuildTerritory {
        entries: Vec<crate::scenes::dialogs::game::guild_territory_dialog::TerritoryEntry>,
        page: i32,
        total: i32,
    },
    ...
    ShowNPCAwake {
        item_name: String,
        materials: Vec<crate::scenes::dialogs::game::npc_awake_dialog::AwakeningMaterial>,
    },
    SetAwakeLocked {
        locked: bool,
    },
    ...
    /// 合成
    ShowCraft {
        recipes: Vec<crate::scenes::dialogs::game::craft_dialog::CraftRecipe>,
    },

    /// 精炼
    ShowRefine {
        item_name: String,
        stats: Vec<crate::scenes::dialogs::game::refine_dialog::RefineStat>,
    ...
    SetRentalPartnerLocked {
        locked: bool,
    },
    CloseItemRental,
    UpdateRentalItemList {
    ...
    OpenTrustMerchant,
    UpdateMerchantItems {
        items: Vec<crate::scenes::dialogs::game::trust_merchant_dialog::MerchantItem>,
        page: i32,
        total: i32,
    },
    CloseTrustMerchant,
    ...
    RequestSceneTransition {
        target: crate::scenes::SceneTransition,
    },
    ...
    UpdateHeroManageList {
        heroes: Vec<crate::scenes::dialogs::game::hero_dialog::ManageHeroEntry>,
    },
    ...
    // Creature/Pet
    SetCreatureCanRename {
        can_rename: bool,
    },
    SetCreatureAutoPickup {
        enabled: bool,
    },
