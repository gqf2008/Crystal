...
pub enum NetworkEvent {
    ...
    ClientVersionResponse {
        result: u8,
    }, // 0: Wrong Version, 1: Correct Version
    ...
    // 服务器 → 客户端
    LoginSuccess {
        characters: Vec<mir2_shared::SelectInfo>,
    },
    LoginFailed {
        reason: String,
    },
    ...
    // 服务器 → 客户端
    CharacterCreated {
        character: mir2_shared::SelectInfo,
    },
    CharacterDeleted {
        index: u32,
    },
    ...
    StartGameBanned {
        packet: mir2_shared::packets::server::StartGameBanned,
    },
    UserInformation {
    ...
    // 服务器 → 客户端
    MapInformation {
        packet: mir2_shared::packets::server::MapInformation,
    },
    MapChanged {
    ...
    ChatRequest {
        message: String,
        linked_items: Vec<mir2_shared::ChatItem>,
    },
    ...
    ItemMerged {
        grid_from: mir2_shared::enums::MirGridType,
    ...
    GroundItem {
        packet: mir2_shared::packets::server::ObjectItem,
    },
    CreditChanged {
        delta: i32,
    },
    ...
    /// 地面金币（ObjectGold）
    ObjectGoldReceived {
        packet: mir2_shared::packets::server::ObjectGold,
    },
    ...
    GroupMembersMapUpdated {
        player_name: String,
        player_map: String,
    },
    GroupMemberLocationUpdated {
        name: String,
        x: i32,
        y: i32,
    },
    ...
    MagicLearned {
        magic: mir2_shared::data::client_data::ClientMagic,
        hero: bool,
    },
    MagicRemoved {
        spell: mir2_shared::enums::Spell,
    ...
    // 服务器 -> 客户端
    ObjectHeroSpawned {
        packet: mir2_shared::packets::server::ObjectHero,
    },
    ObjectHidden {
        object_id: u32,
        hidden: bool,
    ...
    NewMapInfoReceived {
        packet: mir2_shared::packets::server::NewMapInfo,
    },
    WorldMapSetupReceived {
        icons: Vec<mir2_shared::packets::server::WorldMapIcon>,
    },
    ...
    UserInventoryReceived {
        items: Vec<mir2_shared::UserItem>,
    },
    UserEquipmentReceived {
        items: Vec<mir2_shared::UserItem>,
    },
    ...
    TradeItemAdded {
        items: Vec<Option<mir2_shared::data::item::UserItem>>,
    },
    TradeConfirmedEvent {
        locked: bool,
    },
    ...
    // 服务器 -> 客户端
    FriendUpdated {
        friends: Vec<crate::ui::ui_state::FriendEntry>,
    },
    ...
    GuildStorageListReceived {
        items: Vec<Option<mir2_shared::data::client_data::GuildStorageItem>>,
    },
    GuildWarRequested {
        guild_name: String,
    },
    ...
    GuildTerritoryPageReceived {
        territories: Vec<mir2_shared::packets::server::special_systems::TerritoryInfo>,
    },
    ...
    GuildTerritoryPageRequest {
        page: i32,
    },
    PurchaseGuildTerritoryRequest {
        owner: String,
    },

    // --- Warehouse password (PR #1169) — 客户端发起 ---
    UnlockStorageRequest {
        password: String,
    },
    SetStoragePasswordRequest {
        current_password: String,
        new_password: String,
    },
    RemoveStoragePasswordRequest {
        current_password: String,
    },

    // --- Warehouse password (PR #1169) — 服务器回应 ---
    StorageUnlockResultReceived {
        result: u8,
        has_password: bool,
    },
    ...
    RequestMonsterInfoEvent {
        monster_index: i32,
    },
    RequestNPCInfoEvent {
        npc_index: i32,
    },
    RequestItemInfoEvent {
        item_index: i32,
    },
    ...
    // 精炼系统
    DepositRefineItemRequest {
        from: i32,
        to: i32,
    },
    RetrieveRefineItemRequest {
        from: i32,
        to: i32,
    },
    RefineCancelRequest,
    ...
    DepositTradeItemRequest {
        from: i32,
        to: i32,
    },
    RetrieveTradeItemRequest {
        from: i32,
        to: i32,
    },

    // 英雄物品
    TakeBackHeroItemRequest {
        from: i32,
        to: i32,
    },
    TransferHeroItemRequest {
        from: i32,
        to: i32,
    },
    ...
    // 社交
    RequestUserNameQuery {
        user_id: u32,
    },
    RequestChatItemQuery {
        chat_item_id: u64,
    },

    // 物品觉醒
    AwakeningNeedMaterialsRequest {
        unique_id: u64,
        awake_type: mir2_shared::enums::AwakeType,
    },
    AwakeningLockedItemRequest {
        unique_id: u64,
        locked: bool,
    },
    AwakeningRequest {
    ...
    DowngradeAwakeningRequest {
        unique_id: u64,
    },
    ResetAddedItemRequest {
        unique_id: u64,
    },

    // 邮件
    MailLockedItemRequest {
        unique_id: u64,
        locked: bool,
    },
    MailCostRequest {
    ...
    ItemRentalFeeRequest {
        amount: u32,
    },
    ItemRentalPeriodRequest {
        days: u32,
    },
    ...
    // 服务器 -> 客户端
    MailReceived {
        mails: Vec<mir2_shared::packets::server::MailInfo>,
    },
    ...
    NPCMarketPageEvent2 {
        listings: Vec<mir2_shared::packets::server::MarketListing>,
    },
    ConsignItemEvent {
        unique_id: u64,
        success: bool,
    ...
    MarketGetBackRequest {
        listing_id: u64,
    },
    MarketSellNowRequest {
        item_id: u64,
    },
    ...
    IntelligentCreatureListUpdated {
        creatures: Vec<mir2_shared::packets::server::special_systems::IntelligentCreatureInfo>,
    },
    ...
    ItemRentalRequested,
    ItemRentalFeeReceived {
        fee: u32,
    },
    ItemRentalPeriodReceived {
        period: u32,
    },
    RentalItemDeposited {
        unique_id: u64,
    ...
    RentalItemDepositRequest {
        from_slot: i32,
        to_slot: i32,
    },
    RentalItemRetrieveRequest {
        from_slot: i32,
        to_slot: i32,
    },
    ItemRentalConfirm,
    ...
    // 服务器 -> 客户端
    RankingsReceived {
        rankings: Vec<mir2_shared::packets::server::special_systems::RankInfo>,
    },
