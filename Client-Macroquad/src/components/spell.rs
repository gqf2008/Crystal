...
impl SpellType {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::TwinDrakeBlade => "双龙斩",
            Self::Entrapment => "困魔咒",
            Self::FlamingSword => "烈火剑法",
            Self::LionRoar => "狮子吼",
            Self::CrossHalfMoon => "抱月刀",
            Self::BladeAvalanche => "旋风斩",
            Self::ProtectionField => "金刚盾",
            Self::Rage => "破釜沉舟",
            Self::CounterAttack => "反击",
            Self::SlashingBurst => "十步一杀",
            Self::Fury => "怒火",
            Self::ImmortalSkin => "金刚不坏",
            // Wizard (法师)
            Self::FireBall => "火球术",
            Self::Repulsion => "抗拒火环",
            Self::ElectricShock => "电击",
            ...
            Self::FireWall => "火墙",
            Self::Lightning => "疾光电影",
            Self::FrostCrunch => "冰咆哮",
            Self::ThunderStorm => "五雷轰",
            Self::MagicShield => "魔法盾",
            Self::TurnUndead => "驱魔",
            Self::Vampirism => "吸血",
            Self::IceStorm => "冰风暴",
            Self::FlameDisruptor => "焰天火雨",
            Self::Mirroring => "分身术",
            Self::FlameField => "地狱烈焰",
            Self::Blizzard => "暴风雪",
            Self::MagicBooster => "魔力强化",
            Self::MeteorStrike => "流星火雨",
            Self::IceThrust => "冰刺",
            Self::FastMove => "疾走",
            Self::StormEscape => "风遁",
            // Taoist (道士)
            ...
            Self::Poisoning => "施毒术",
            Self::SoulFireBall => "灵魂火符",
            Self::SummonSkeleton => "召唤骷髅",
            Self::Hiding => "隐身术",
            Self::MassHiding => "集体隐身术",
            Self::SoulShield => "幽灵盾",
            Self::Revelation => "启示录",
            Self::BlessedArmour => "神圣战甲术",
            Self::EnergyRepulsor => "气功波",
            Self::TrapHexagon => "困魔阵",
            Self::Purification => "净化术",
            Self::MassHealing => "群体治愈术",
            Self::Hallucination => "迷魂术",
            Self::UltimateEnhancer => "终极强化",
            Self::SummonShinsu => "召唤神兽",
            Self::Reincarnation => "转生术",
            Self::SummonHolyDeva => "召唤圣兽",
            Self::Curse => "诅咒术",
            Self::Plague => "瘟疫",
            Self::PoisonCloud => "毒云",
            Self::EnergyShield => "能量盾",
            Self::PetEnhancer => "宠物强化",
            Self::HealingCircle => "治愈光环",
            // Assassin (刺客)
            ...
            Self::DoubleShot => "双射",
            Self::ExplosiveTrap => "爆炸陷阱",
            Self::DelayedExplosion => "延时爆炸",
            Self::Meditation => "冥想",
            Self::BackStep => "后跳",
            Self::ElementalShot => "元素射击",
            Self::Concentration => "专注",
            Self::Stonetrap => "石陷阱",
            Self::ElementalBarrier => "元素屏障",
            Self::SummonVampire => "召唤吸血鬼",
            Self::VampireShot => "吸血射击",
            Self::SummonToad => "召唤蟾蜍",
            Self::PoisonShot => "毒射击",
            Self::CrippleShot => "致残射击",
            Self::SummonSnakes => "召唤蛇群",
            Self::NapalmShot => "燃烧射击",
            Self::OneWithNature => "自然一体",
            Self::BindingShot => "束缚射击",
