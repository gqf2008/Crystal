...
mod tests {
    ...
    #[test]
    fn test_movement_interpolation_idle() {
        ...
        let movement_anim = world.get::<&MovementAnimation>(entity).unwrap();
        assert_eq!(movement_anim.offset_move, (0.0, 0.0));
        assert_eq!(movement_anim.move_distance, 0);
    }
    
    #[test]
    fn test_movement_interpolation_walking() {
        let mut world = World::new();
        ...
        let entity = world.spawn((
            Player {
                ...
                direction: 0, // 右方向
                frame_index: 2,
                move_mode: MoveMode::DirectFollow,
                target_x: 110.0,
                target_y: 100.0,
                ..Default::default()
            },
        ...
        let movement_anim = world.get::<&MovementAnimation>(entity).unwrap();
        assert_eq!(movement_anim.move_distance, 1); // Walk = 1格
        // offset_move 应该不为 (0, 0)，因为在移动中
        assert_ne!(movement_anim.offset_move, (0.0, 0.0));
    }
}
