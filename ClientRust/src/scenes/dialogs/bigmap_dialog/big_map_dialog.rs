...
pub struct BigMapDialog {
    visible: bool,
    pub current_map: Option<BigMapRecord>,
    pub target_map_index: u16,
    pub npcs: Vec<BigMapNPCRow>,
...
impl BigMapDialog {
    ...
    pub fn set_current_map(&mut self, map: BigMapRecord) {
    ...
    pub fn add_npc(&mut self, npc: BigMapNPCRow) {
        self.npcs.push(npc);
    }
    ...
    pub fn get_selected_npc(&self) -> Option<&BigMapNPCRow> {
    ...
    pub fn get_visible_npcs(&self) -> Vec<&BigMapNPCRow> {
    ...
    pub fn get_filtered_npcs(&self) -> Vec<&BigMapNPCRow> {
