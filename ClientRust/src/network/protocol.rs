...
// Import packet types that were previously in protocol_packets module
// These are now defined in SharedRust and need to be imported for ServerMessage enum
use mir2_shared::packets::server::{
    // Types not yet defined locally (from old protocol_packets)
